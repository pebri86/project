...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Perum Peruri - Banknote Production Reporting System</title>
		...
		<div id="wrapper">
			...
			<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
				<div class="navbar-header">
					...
					<a class="navbar-brand" rel="home" target="_blank" href="http://www.peruri.co.id"> <img style="max-width: 350px; margin-top: -7px;" src="<?php echo base_url("assets/images/logo-baru.png"); ?>" > </a>
					<a class="navbar-brand" href="index.html">Banknote Production Reporting System</a>
				</div>
				<!-- /.navbar-header -->
				<ul class="nav navbar-top-links navbar-right">
					...
					<!-- /.dropdown -->
					<li>
						<a href="#"><i class="fa fa-lock fa-fw"></i> Logout</a>
					</li>
				</ul>
					...
					<div class="sidebar-nav navbar-collapse">
						<ul class="nav" id="side-menu">
							<li class="sidebar-search">
								<center>
									<div>
										<i class="fa fa-user fa-3x circle"></i>
									</div>
									Welcome User!
								</center>
							<li>
							...
							<li>
								...
								<ul class="nav nav-second-level">
									...
									<li>
										<a href="<?php echo base_url("submission");?>"> Target Penyerahan</a>
									</li>
									<li>
										<a href="#">Target Produksi <span class="fa arrow sublevel"></span></a>
										<ul class="nav nav-third-level">
											<li>
												<a href="<?php echo base_url("production_plan/page/1");?>"> Cetak Rata</a>
											</li>
											<li>
												<a href="<?php echo base_url("production_plan/page/2");?>"> Cetak Dalam</a>
											</li>
											<li>
												<a href="<?php echo base_url("production_plan/page/3");?>"> Cetak Nomor</a>
											</li>
											<li>
												<a href="<?php echo base_url("production_plan/page/4");?>"> Verifikasi Lembar Besar</a>
											</li>
											<li>
												<a href="<?php echo base_url("production_plan/page/5");?>"> Penyelesaian Masinal</a>
											</li>
											<li>
												<a href="<?php echo base_url("production_plan/page/6");?>"> Penyelesaian Darurat</a>
											</li>
											<li>
												<a href="<?php echo base_url("production_plan/page/7");?>"> Produk Akhir</a>
											</li>
										</ul>
										<!-- /.nav-third-level -->
								</ul>
